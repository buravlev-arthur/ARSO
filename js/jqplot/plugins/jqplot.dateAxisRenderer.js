...
(function($) {  
    ...
    $.jqplot.DateTickFormatter = function(format, val) {
        ...
        var formatedDate = $.jsDate.strftime(val, format);
        formatedDate = formatedDate.replace('Jan', 'Янв');
        formatedDate = formatedDate.replace('Feb', 'Фев');
        formatedDate = formatedDate.replace('Mar', 'Мар');
        formatedDate = formatedDate.replace('Apr', 'Апр');
        formatedDate = formatedDate.replace('May', 'Май');
        formatedDate = formatedDate.replace('Jun', 'Июн');
        formatedDate = formatedDate.replace('Jul', 'Июл');
        formatedDate = formatedDate.replace('Aug', 'Авг');
        formatedDate = formatedDate.replace('Sep', 'Сен');
        formatedDate = formatedDate.replace('Oct', 'Окт');
        formatedDate = formatedDate.replace('Nov', 'Ноя');
        formatedDate = formatedDate.replace('Dec', 'Дек');
        return formatedDate;
    };
