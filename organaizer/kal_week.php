<div id="kalendar_block">
		...
		<div id="kal_weeks_buttons">
			<div id="week_back" onclick="get_kalendar(<?= ($_GET["where"]-604800) ?>,'kal_week')"><прошла€ недел€</div>
			<div id="week_next" onclick="get_kalendar(<?= ($_GET["where"]+604800) ?>,'kal_week')">следующа€ недел€></div>
		</div>
			<div id="kal_variants">
